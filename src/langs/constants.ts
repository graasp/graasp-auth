export const AUTH = {
  ...
  PRIVACY_POLICY_CHECKBOX_LABEL: 'PRIVACY_POLICY_CHECKBOX_LABEL',
  TERMS_OF_SERVICE_CHECKBOX_LABEL: 'TERMS_OF_SERVICE_CHECKBOX_LABEL',
  PRIVACY_POLICY_LINK_LABEL: 'PRIVACY_POLICY_LINK_LABEL',
  TERMS_OF_SERVICE_LINK_LABEL: 'TERMS_OF_SERVICE_LINK_LABEL',
};
